...
System.out.println("=== forgot-password.jsp ===");
...
<title>Fredon Immobilier — Mot de passe oublié</title>
<link
...
:root {
	...
	--error: #ef4444;
	--success: #10b981;
	--shadow: 0 32px 100px rgba(200, 134, 10, .13), 0 4px 28px rgba(0, 0, 0, .07);
}
...
.blob-1 { width:580px; height:580px; background:#f5dfa0; top:-180px; left:-140px; animation-delay:0s; }
.blob-2 { width:440px; height:440px; background:#d4e8c2; bottom:-100px; right:5%; animation-delay:-5s; }
.blob-3 { width:310px; height:310px; background:#f8cda0; top:25%; right:-70px; animation-delay:-10s; }
.blob-4 { width:270px; height:270px; background:#c8d8f8; bottom:8%; left:18%; animation-delay:-3s; }
...
.step-v-info { padding-top: 6px; padding-bottom: 28px; }
.step-v-title {
	font-family: 'Syne', sans-serif;
	font-size: 13px; font-weight: 700;
	color: rgba(255,255,255,.9);
}
.step-v-title.inactive { color: rgba(255,255,255,.4); font-weight: 500; }
.step-v-desc { font-size: 11px; color: rgba(255,255,255,.45); margin-top: 2px; }
...
.form-header p { font-size: 14px; color: var(--mid); line-height: 1.65; }
...
.step-name { font-size: 10px; color: var(--soft); font-weight: 600; letter-spacing: .5px; text-transform: uppercase; white-space: nowrap; }
.step-name.active { color: var(--blue); }
.step-name.done   { color: var(--teal); }
.step-line { width: 40px; height: 2px; background: rgba(200,134,10,.15); margin-bottom: 20px; flex-shrink: 0; }
...
/* Form */
form { display: flex; flex-direction: column; gap: 16px; animation: fadeUp .6s .3s both; }
...
.field:has(input:focus) .ico { color: var(--blue-light); }
...
.btn-submit {
	...
	cursor: pointer; letter-spacing: .1px; margin-top: 2px;
...
.btn-submit:hover { transform: translateY(-2px); box-shadow: 0 12px 36px rgba(31,82,212,.42); }
...
.info-box i { color: var(--blue-light); font-size: 15px; margin-top: 1px; flex-shrink: 0; }
.info-box p { font-size: 13px; color: var(--blue); line-height: 1.6; }

.back-link { text-align: center; animation: fadeUp .6s .45s both; }
.back-link a {
...
.prop-card {
	...
	border-radius: 20px;
	overflow: hidden;
	box-shadow: 0 28px 56px rgba(0,0,0,.28), inset 0 1px 0 rgba(255,255,255,.22);
...
.cloud-1 { width:36px; height:11px; top:20px; left:10px; animation-duration:12s; }
.cloud-1::before { width:18px; height:18px; top:-9px; left:4px; }
.cloud-1::after  { width:13px; height:13px; top:-6px; left:14px; }
.cloud-2 { width:25px; height:8px; top:12px; left:60px; opacity:.55; animation-duration:18s; animation-delay:-6s; }
.cloud-2::before { width:13px; height:13px; top:-6px; left:3px; }
@keyframes cloudDrift {
	0%   { transform: translateX(0); }
	100% { transform: translateX(180px); opacity: 0; }
}

.house-svg { position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 124px; height: 84px; }

.prop-info { padding: 12px 13px 13px; }
.prop-price { font-family: 'Syne', sans-serif; font-size: 15.5px; font-weight: 700; color: #FFD700; margin-bottom: 3px; }
.prop-title { font-size: 10px; font-weight: 500; color: rgba(255,255,255,.9); margin-bottom: 5px; }
.prop-tags { display: flex; gap: 4px; flex-wrap: wrap; }
.tag { font-size: 8.5px; font-weight: 500; padding: 2px 6px; border-radius: 99px; color: rgba(255,255,255,.85); border: 1px solid rgba(255,255,255,.2); background: rgba(255,255,255,.1); }
...
.mini-card-1 { top: 12%; animation-duration: 5s; animation-delay: -.5s; }
.mini-card-2 { bottom: 16%; animation-duration: 6s; animation-delay: -2s; }
@keyframes miniFloat {
	0%,100% { transform: translateY(0); }
	50%     { transform: translateY(-8px); }
}
.mini-label { font-size: 8.5px; color: rgba(255,255,255,.55); margin-bottom: 2px; text-transform: uppercase; letter-spacing: 1px; }
.mini-value { font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 700; color: #fff; }
.mini-sub   { font-size: 8.5px; color: rgba(255,255,255,.55); margin-top: 1px; }
...
.chat-bubble-1 { top: 18%; border-bottom-left-radius: 3px; animation-duration: 5.5s; animation-delay: -1s; }
.chat-bubble-2 { bottom: 20%; border-bottom-left-radius: 3px; animation-duration: 7s; animation-delay: -3s; }
@keyframes chatFloat {
	0%,100% { transform: translateY(0); }
	50%     { transform: translateY(-7px); }
}
.chat-dot { display: inline-block; width: 5px; height: 5px; border-radius: 50%; background: #4ade80; margin-right: 4px; box-shadow: 0 0 5px #4ade80; }
...
@media (max-height: 700px) {
	.panel-right { padding: 28px 40px; gap: 16px; }
	.panel-left  { padding: 28px 36px 28px; }
	.scene       { margin: 8px 0 6px; }
}
</style>
</head>
<body>
...
<div class="card">
  ...
  <div class="panel-left">
    ...
    <!-- LOGO — vrai fichier comme login.jsp -->
    <div class="logo-wrap">
    ...
    <!-- Scène immobilière -->
    <div class="scene">
      <div class="chat-bubble chat-bubble-1"><span class="chat-dot"></span>Réinitialisation sécurisée</div>
      <div class="chat-bubble chat-bubble-2"><span class="chat-dot"></span>Code envoyé par email</div>
      ...
      <div class="prop-card">
        <div class="house-thumb">
          ...
          <svg class="house-svg" viewBox="0 0 130 88" xmlns="http://www.w3.org/2000/svg">
            ...
            <ellipse cx="85" cy="11" rx="4" ry="5" fill="rgba(200,200,200,0.35)">
              <animate attributeName="cy" values="11;6;11" dur="2s" repeatCount="indefinite"/>
            ...
            <line x1="37" y1="50" x2="37" y2="64" stroke="#c8a060" stroke-width="1"/>
            <line x1="28" y1="57" x2="46" y2="57" stroke="#c8a060" stroke-width="1"/>
            <rect x="84" y="50" width="18" height="14" rx="2" fill="#87CEEB" stroke="#c8a060" stroke-width="1.5"/>
            <line x1="93" y1="50" x2="93" y2="64" stroke="#c8a060" stroke-width="1"/>
            <line x1="84" y1="57" x2="102" y2="57" stroke="#c8a060" stroke-width="1"/>
    ...
    <div class="steps-vertical">
      <div class="step-v">
        <div class="step-v-circle active">1</div>
        <div class="step-v-info">
          <div class="step-v-title">Saisir votre email</div>
          <div class="step-v-desc">Nous vous envoyons un code de vérification</div>
        </div>
      </div>
      <div class="step-v">
        <div class="step-v-circle">2</div>
        <div class="step-v-info">
          <div class="step-v-title inactive">Vérifier le code</div>
  ...
  <div class="panel-right">
    ...
    <div class="steps-row">
      <div class="step-item">
        ...
        <span class="step-name active">Email</span>
      </div>
    ...
    <div class="form-header">
      ...
      <p>Saisissez votre adresse e-mail et nous vous enverrons un code de vérification sécurisé.</p>
    </div>
    ...
    <div class="info-box">
      <i>💡</i>
      <p>Vérifiez aussi votre dossier <strong>Spam</strong> si vous ne recevez pas l'email sous 2 minutes.</p>
    </div>
...
(function() {
  ...
  var COLORS = ['#1f52d4','#c8860a','#0e9e8a','#e03060','#7c3aed','#0e7490','#b45309','#166534'];
  for (var i = 0; i < 18; i++) {
    houses.push({
